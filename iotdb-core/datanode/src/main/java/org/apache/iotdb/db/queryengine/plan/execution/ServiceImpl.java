...
//        pipeInfo.getScanStatus(SourceId).setCloudFragmentId(CloudFragmentId);
        pipeInfo.getJoinStatus(SourceId).setCloudSendFragmentId(CloudFragmentId);
...
//            client.AnsMessage(pipeInfo.getScanStatus(SourceId).getEdgeFragmentId(),SourceId,pipeInfo.getScanStatus(SourceId).getOffset());
            client.AnsMessage(pipeInfo.getJoinStatus(SourceId).getEdgeRecFragmentId(),SourceId,pipeInfo.getJoinStatus(SourceId).getOffset());
